export const useCalendar = () => {
    ...
    function getCalendarData() {
        ...
        var previousMonthDays = getDaysInMonth(previousMonthYear, previousMonth);
        ...
        for (var i = 1; i <= previousMonthDays; i++) {
            previousMonthData.days.push(new Date(previousMonthYear, previousMonth, i));
        }
        ...
        var nextMonthDays = getDaysInMonth(nextMonthYear, nextMonth);
        var nextMonthData = {
